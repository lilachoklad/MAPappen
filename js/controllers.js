...
//Kod för att endast hämta en marker och visa den för den valda toan på undersidan	
toaControllers.controller('MarkerController', function MarkerController ($scope, $http, $log){
    ...
    var createMarker = function (info){
        ...
        var marker = new google.maps.Marker({
            map: $scope.map,
            position: new google.maps.LatLng(info.lat, info.long), //om, man kan få dom här att hämta lat och long genom index för vald toa
            title: info.namn,
            platsen: info.ort
        });
        marker.content = '<div class="infoWindowContent">' + info.ort + '</div>';
